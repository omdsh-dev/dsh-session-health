...
## DSH 0.1.3-alpha.2 Compatibility (verified)

This plugin has been migrated to the DSH 0.1.3-alpha.2 harness, and full end-to-end verification was completed in an isolated consumer of `local harness 0.1.3-alpha.2`:
